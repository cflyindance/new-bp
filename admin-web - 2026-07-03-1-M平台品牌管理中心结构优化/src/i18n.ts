...
const messages = {
  zh: {
    ...
    "shell.viewSwitchHint": "切换门店版、连锁版或 M 平台视角",
    ...
    "shell.perspectiveBrandHint": "仅查看当前品牌下的多家门店",
  ...
  en: {
    ...
    "shell.viewSwitchHint": "Switch between store, chain, or M Platform view",
    ...
    "shell.perspectiveBrandHint": "Stores under the current brand only",
