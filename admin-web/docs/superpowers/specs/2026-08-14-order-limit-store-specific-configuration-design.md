...
> **状态更新（2026-08-18）：部分被替代。** `storeConfigs[storeId]` 按店隔离、发布裁剪和历史迁移仍有效；独立「商品配置」步骤、限购数量门店 / 产线 Tab、场景矩阵及旧步骤序已被 `2026-08-18-order-limit-product-quantity-merge-design.md` 替代。当前非解耦实现统一使用可筛选、搜索和分页的完整商品规则列表。
