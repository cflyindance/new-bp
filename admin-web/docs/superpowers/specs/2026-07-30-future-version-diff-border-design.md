...
| 差异 | 唯一宿主 |
|------|----------|
| 侧栏 brand-mgmt | `[data-nav-module="…"]`（门店管理改打「非MVP版本」标签，不再红框） |
| 系统设置「平台预设」 | （改打「非MVP版本」标签，不再红框；MVP 仍隐藏） |
...
| 视角「集团总部」 | （改打「非MVP版本」标签，不再红框；MVP 仍隐藏） |
| 视角「M 平台」 | （改打「非MVP版本」标签，不再红框；MVP 仍隐藏） |
| 前厅「查看方式」中的「按产线」 | `[data-foh-settings-view-mode="by-line"]` |
...
**明确不标：** 营业时间弹窗「每周重复」；AI 浮层整板；门店管理 / 团队「绩效与培训」「设置」（改打「非MVP版本」标签）。
