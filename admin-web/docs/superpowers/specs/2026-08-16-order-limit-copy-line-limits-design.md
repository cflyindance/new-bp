...
> **状态更新（2026-08-18）：主区入口已被替代。** 当前完整商品规则列表通过产线筛选、规则勾选和批量应用数量完成跨规则编辑，不再在产线 Tab 标题栏展示「复制到其他产线」。底层同键复制逻辑仅作为历史能力保留，当前交互以 `2026-08-18-order-limit-product-quantity-merge-design.md` 为准。
