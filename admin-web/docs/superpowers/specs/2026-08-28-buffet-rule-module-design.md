...
> 权威扩展：自 2026-08-31 起，“菜品集”限购对象及其新增 4 种组合以
> [《自助餐规则菜品集限购对象设计》](./2026-08-31-buffet-dish-set-limit-design.md) 为准；
> 本文中的“8 种组合”和 `category | dish` 描述均应结合该扩展阅读。

> 权威扩展：自 2026-08-31 起，每轮总量上下限、固定每轮额度、按人数每轮额度、
> 指定分类/菜品集及相同菜品的组合关系，以
> [《自助餐每轮总量、指定对象与相同菜品组合规则》](./2026-08-31-buffet-per-round-quantity-combination-design.md) 为准。
> 该扩展明确覆盖本文“不支持固定每桌每轮上限”和“按桌/订单不配置轮次”的旧限制。
