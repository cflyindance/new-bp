...
- [ ] 增加逐项删除及批量删除原生确认；删除只清理对应场景目标额度和成员记录，不影响集合共享额度与其他场景。
...
- 浏览器测试草稿 29 未发布：人数场景 1–2 人保留 3 商品、3 人以上保留 2 商品；保存下一场景、刷新恢复、批量数量、删除后取消恢复、成员不足阻止保存均已验证。
