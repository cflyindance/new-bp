/**
 * 后厨 · 跨票种显示：seq 271 打印菜品编号（打包单/订单收据/厨房单多选，结构对齐 seq 36）。
 */
...
export function renderPrintDishCodeTicketsMultiselectHtml(seq: number): string {
  ...
  return `
    <div
      ...
      data-print-dish-code-tickets="${seq}"
      role="group"
