...
const messages = {
  zh: {
    ...
    "ai.contextNote":
      "已接入全站设置 catalog：支持按名称/场景检索并跳转设置页；简单开关项可在此对话中直接开启或关闭（与设置页 localStorage 同步）。",
    "ai.quickAria": "快捷示例指令",
  ...
  en: {
    ...
    "ai.contextNote":
      "Connected to the global settings catalog: search by name or scenario and jump to the settings page; simple toggles can be changed here (synced with settings page localStorage).",
