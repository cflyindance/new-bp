...
const messages = {
  zh: {
    ...
    "shell.versionSwitchHint": "切换 MVP 版本或未来版本，影响集团总部视角下一级导航展示",
    ...
    "shell.productVersionFuture": "未来版本",
  ...
  en: {
    ...
    "shell.versionSwitchHint": "Switch MVP or future version; affects group HQ sidebar nav",
    ...
    "shell.productVersionFuture": "Future",
