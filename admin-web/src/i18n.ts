...
const messages = {
  zh: {
    ...
    "shell.productVersionMvpHint": "全视角隐藏日志管理、重新引导、AI助手；视角切换隐藏集团总部与M平台；系统设置内隐藏平台预设；集团总部视角下另隐藏品牌管理、门店列表；品牌视角另隐藏门店列表与区域筛选；首次登录自动跳过业态产线引导",
  ...
  en: {
    ...
    "shell.productVersionMvpHint": "All views: hide log mgmt, restart setup, AI assistant, group HQ & M Platform view; settings: hide preset; group HQ nav: brand & store list; brand nav: store list & region filter; skip onboarding on first login",
