...
(function () {
  ...
  var messages = {
    zh: {
      ...
      "manage.attendanceIncome": "考勤收入",
      "manage.incomeMeta": "考勤 + 小费",
    ...
    en: {
      ...
      "manage.attendanceIncome": "Attendance pay",
      "manage.incomeMeta": "Pay + tips",
      "manage.incomeSvcw": "SVCW",
      "manage.incomeTips": "Tips",
  ...
  var PAGE_I18N = [
    ...
    ["#sum-income-svcw-label", "manage.incomeSvcw"],
    ["#sum-income-tips-label", "manage.incomeTips"],
  ...
  var FIELD_HELP = {
    zh: {
      ...
      "seg-meal": {
        ...
        body: "当日带薪用餐或休息时长（如 0:30）。带薪餐休计入工作时长，不扣减 Regular 工时；用于合规记录与员工签字明细。",
        adp: null,
      },
      "seg-paid-meal-break": {
        title: "带薪用餐休息 · Paid Meal Break",
    ...
    en: {
      ...
      "seg-meal": {
        ...
        body: "Duration of paid meal or rest break for the day (e.g., 0:30). Paid breaks count as time worked and are not deducted from Regular hours; used for compliance and the signed detail.",
        adp: null,
      },
      "seg-paid-meal-break": {
        title: "Paid Meal Break",
