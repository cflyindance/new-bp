...
(function () {
  ...
  var messages = {
    zh: {
      ...
      "manage.wideTableHint": "与 Manage Payroll 模板一致的 12 列；均可手工修改。时薪请在考勤明细各日 Rate 列维护。",
      ...
      "detail.dailyTitle": "本期按日考勤明细（按周）",
      "detail.dailyHint": "按第1周 / 第2周分组展示每日 In/Out 与当日汇总，并在每周末展示该周考勤汇总。",
      ...
      "unsaved.title": "确认返回",
      "unsaved.body": "检测到该员工数据已修改，但尚未点击“确定并保存”。是否仍返回员工列表？",
      "unsaved.leave": "确认返回",
      "unsaved.stay": "继续编辑",
    ...
    en: {
      ...
      "manage.wideTableHint": "12 columns aligned with the Manage Payroll template; all fields are editable. Set hourly rates per day in Time entries.",
      ...
      "detail.draftBadge": "Draft preview · Not final",
      ...
      "detail.dailyTitle": "Daily time detail (by week)",
      "detail.dailyHint":
        "Daily In/Out and totals grouped by Week 1 / Week 2, with a weekly summary at the end of each week.",
      ...
      "unsaved.body":
        "This employee has unsaved changes. You have not clicked Confirm & save. Leave anyway?",
      "unsaved.leave": "Leave",
      ...
      "export.batchAdp": "Batch export ADP CSV",
  ...
  var PAGE_I18N = [
    ...
    ["#btn-back-employees", "nav.backEmployees"],
    ...
    ["label[for='employee-store-filter']", "table.store"],
    ["#employee-store-filter option[value='']", "filter.allStores"],
    ...
    [".payroll-workspace-tabs", null, "aria-label", "tab.aria"],
    ["[data-tab='manage']", "tab.manage"],
    ["[data-tab='detail']", "tab.detail"],
    ["[data-tab='adp']", "tab.adp"],
    ...
    ["#manage-wide-table-hint", "manage.wideTableHint"],
    ["[data-action='confirm-employee']", "manage.confirmSave"],
    ["#detail-draft-badge", "detail.draftBadge"],
    [".payroll-detail-print-title", "detail.title"],
    ["#detail-meta-label-role", "detail.meta.roles"],
    ["#detail-meta-label-hire-date", "detail.meta.hireDate"],
    ["#detail-meta-label-employee", "detail.meta.employee"],
    ["#detail-meta-label-pay-date", "detail.meta.payDate"],
    ["#detail-meta-label-pay-period", "detail.meta.payPeriod"],
    ["#detail-meta-label-period-report", "detail.meta.periodNo"],
    ["#tab-panel-detail .payroll-detail-print-header + div + div p:first-child", "detail.declaration", "prefix"],
    ...
    ["#payrollDetailExportMenu .export-menu-item:nth-child(2)", "export.asCsv"],
    ["#payrollDetailExportMenu .export-menu-item:nth-child(3)", "export.email"],
    ["#btn-print-detail", "export.printPdf"],
    ["#tab-panel-adp + p", "export.adpHint"],
    ["#btn-export-csv", "export.adpCsv"],
    ...
    ["#workspaceUnsavedConfirmModal .modal-header h3", "unsaved.title"],
    ["#workspaceUnsavedConfirmModal .modal-body", "unsaved.body"],
