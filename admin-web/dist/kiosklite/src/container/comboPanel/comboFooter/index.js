...
import styles from './comboFooter.module.scss';
// import BackIcon from '../../../component/backIcon';
// import Icon from '../../../component/icon';
import ComboItemsDetailModal from './comboItemsDetailModal';
...
class ComboFooter extends React.Component {
  ...
  handleAddToCart = async () => {
    ...
    if (isAddToCart) {
      await this.props.submitCurrentOrderCombo();
      return;
    } else {
      let isItemPrice =
  ...
  componentDidMount() {
    const { isInFreeItem, max, isPromotionItem, isSpecialItem } = this.props;
    ...
    return (
      <React.Fragment>
        <div className={styles.footBtnBox}>
          {/* <div className={styles.backBtn}>
            <BackIcon
              ...
              clickHandler={handleGoBack ? handleGoBack : this.backConfirm}
            ></BackIcon>
          </div> */}
          ...
          {/* <div className={styles.details} onClick={this.handleShowDetail}>
              <i className={styles.num}>{n}</i>
              <span>
                {t('items')}
                <Icon type="fenxiang" size={3} className={styles.arrow} />
              </span>
            </div> */}
          <div
            className={[
                ...
                {isInFreeItem ? (
                  ...
                  <span>
                    ...
                    {getPromotionModalDisplayPrice({
                      isPromotionItem,
                      isExchangePurchase,
                      totalPrice: floatNumberRounding(
                        priceTotal * orderDishCount
                      ),
                    })}
                  </span>
                )}
        ...
        <ComboItemsDetailModal
          ...
          handleChildUpTop={this.props.handleChildUpTop}
