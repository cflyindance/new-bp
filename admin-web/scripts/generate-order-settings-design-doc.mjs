...
const reasons = {
  ...
  "order-discount":
    "折扣预设（446）与固定原因策略（162/163）；seq 164 自定义折扣原因已退役。",
  "order-surcharge":
...
push(
  ...
  "- **自定义折扣原因（164）** 已全版本退役，不计入当前订单 catalog。",
...
push(
  ...
  "|-----|----------|----------|------|",
  "| 164 | 自定义折扣原因 | 已退役 | 不进入当前设置 catalog，仅保留历史原始记录。 |",
  ...
  "| 新组 | groupKey | 条数 | 范围 |",
  "|------|----------|------|------|",
  "| 折扣 | `order-discount` | 3 | 446、162、163 |",
  ...
  "| 新组 | groupKey | 条数 | 范围 |",
  "|------|----------|------|------|",
  "| 折扣与加收 | `discount-surcharge` | 7 | 147/149/446/447/161–163 |",
  ...
  "| 643 | 开单前，换桌 | 前厅 · `tables-floor` | 按产线配置不启用、可选换桌或必须换桌。 |",
  ...
  "",
  "订单中心 `order-init-scenario` 保留 **107/108/111/126/619/625/643/592** 共 8 条（v1.8 再迁 7 条，仅留 126）。",
  "",
...
push(
  ...
  "## 7. 边界说明",
  "",
  "- 当前订单 catalog 保留有效项；hub override 增补 147、446、447 等，seq 164 已退役；v1.15–v1.16 拆组见 §3.2–§3.3。",
