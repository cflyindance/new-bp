...
for (const [source, expected, label] of [
  ...
  [shell, "legacyBDialogDismissedForVisit", "visit-local dismissal state"],
  [shell, "data-legacy-b-page-content", "inert background wrapper"],
  ...
  [main, "beginLegacyBVisit", "legacy-b visit lifecycle binding"],
