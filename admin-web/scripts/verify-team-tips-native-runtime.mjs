...
for (const token of ["MutationObserver", "data-native-on", "AbortController", "requestAnimationFrame", "controller.abort()", "observers.forEach", "timers.clear()", "intervals.clear()", "animationFrames.clear()"]) {
