...
assert.match(tablesSource, /enrichAreasWithDurationBilling/);
assert.match(tablesSource, /enrichTableResponseWithDurationBilling/);
assert.match(tablesSource, /export async function getAreas/);
assert.match(tablesSource, /export async function getTables/);
assert.match(tablesSource, /export async function fetchTable/);
assert.match(tablesSource, /enrichTableResponseWithDurationBilling\(response, localStorage, areaId\)/);
