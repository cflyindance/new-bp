...
check("readFormTable persists durationBillingRuleId", () => {
  assert.match(floorPlanSource, /durationBillingRuleId,/);
  assert.match(floorPlanSource, /canShowDurationBillingRuleField\(category\)/);
});
