...
const reasons = {
  ...
  "ui-operation-preferences":
    "时间制式、菜单模式等门店级操作体验偏好；对标 Clover 的通用偏好设置。",
...
const assignMap = {
  ...
  "ui-operation-preferences": [168, 174],
...
push(
  "# 系统设置 · 设置二级导航重设计方案",
  "",
  "> 文档版本：v1.2（165 默认主界面迁前厅）  ",
  "> 数据范围：系统设置 catalog **14** 条（终版归属系统 19 条；652/653 跨 hub 至前厅、165 迁前厅、513/514 去重见前厅 §3.10）  ",
  ...
  "### 1.2 设计目标",
  "",
  "- 二级导航收敛为 **5 组**；catalog **14** 条（C 端语言 652/653 展示于前厅；165 默认主界面迁前厅，见前厅 §3.x）",
...
push(
  ...
  "",
  "### 3.2 v1.2 默认主界面迁出（已确认）",
  "",
  "| seq | 处理 | 说明 |",
  "|-----|------|------|",
  "| 165 | 前厅 · `pos-shell-landing` | POS 登录后默认主界面（MAIN/TABLE/ORDER/RECALL）；门店 × 产线兜底；`settings-hub-override.mjs` |",
  "",
  "本 hub **界面与操作偏好** 仅保留 **168**（24 小时制）、**174**（菜单模式）。",
  "",
  "---",
  "",
  "## 4. 分类结果明细",
...
push(
  ...
  "| 界面与操作偏好 | 基本设置（24小时制、菜单模式）；165 默认主界面见前厅 · 主界面与导航 |",
  "| 地址与地图服务 | 地图 |",
