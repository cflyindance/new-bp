...
const reasons = {
  ...
  "pos-find-order-list":
    "POS 找单页列表：合计展示、未加小费筛选、盘点模式、批量关闭、找单页打印；原订单中心 `find-order-list` v1.17 迁入。",
  "pos-checkout-entry":
  ...
  "guest-menu-global":
    "全店默认菜单组、点单模式、首页入口与列表版式（含 600 纯展示、604 Pro）；532/612 为 **品牌露出显隐**（eMenu）；509 展示账户积分（v1.21 自会员迁入）；542 为 Kiosk 本地菜单标签源开关；Kiosk/eMenu 封面·门店 Logo **维护**在素材中心（555/556 等），见 §3.15。",
...
const assignMap = {
  ...
  "guest-order-rules": [
    91, 443, 502, 567, 487, 488, 489, 490, 491, 623, 622, 504, 505, 506, 507, 510, 527, 571, 572, 574, 575, 569, 570, 573, 577, 578, 579, 580, 581, 597, 598, 98,
    503,
  ],
