...
assert.equal(new Set(first.map((rule) => rule.defaultScenarioKey)).size, 18);
...
assert.equal(partial.length, 19, "1 条系统默认规则、1 条草稿和 17 条缺失默认规则");
...
assert.equal(legacyKeyRules.length, 18, "旧两段键应安全映射为整单 canonical key，并仅补齐其余 17 条");
