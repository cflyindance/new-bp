...
if (template.includes('id="summaryPoolCount"') || template.includes('id="summaryPoolCountMetric"')) failures.push("date task: summary pool-count metric must stay removed");
...
if (!/detailPoolAmount'\)\.textContent\s*=.*money\((?:Number\()?summary\.poolAmount/.test(details)) failures.push("date detail: pool amount must always render");
