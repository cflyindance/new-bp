 ...
 * SSOT：dist/TipOut、dist/Configuration center、dist/emenu-pro、dist/emenu-new、dist/kiosklite
 */
...
const EMBEDDED_DIST_DIRS = ["emenu-pro", "TipOut", "Configuration center", "emenu-new", "kiosklite"];
