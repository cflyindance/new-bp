...
const getHost = () => apiMap[getRuntimeEnv()] || apiMap.production;
...
class CRMIntegrationClient {
  ...
  async searchCustomers(params) {
    ...
    const url = `${getHost()}/integration/customers/search`;
    return axiosGet(url, {
      params,
      data: {},
      headers: {
  ...
  async getCustomerAssets(customerId) {
    const token = await this.getValidToken();
    const url = `${getHost()}/integration/promotion/assets`;
    return axiosGet(url, {
      params: { customerId },
      data: {},
      headers: {
  ...
  async getCustomerInfo(id) {
    const token = await this.getValidToken();
    const url = `${getHost()}/integration/customers/get`;
    return axiosGet(url, {
      params: { id },
      data: {},
      headers: {
  ...
  async createNewCustomer(data) {
    const token = await this.getValidToken();
    const url = `${getHost()}/integration/customers/create`;
  ...
  async getMerchantReward() {
    const token = await this.getValidToken();
    const url = `${getHost()}/integration/promotion/reward`;
    return axiosGet(url, {
      data: {},
      headers: {
        'x-api-token': token,
